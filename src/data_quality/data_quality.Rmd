...
abundance_2 <- read_csv("results/data/glyhunter_results_GZII/summary_intensity.csv")
...
abundance_3 <- read_csv("results/data/glyhunter_results_XZ/summary_intensity.csv")
...
write_csv(qc_cv, "results/source_data/Supplementary_Figure_2a.csv")
```
...
write_csv(qc_cor, "results/source_data/Supplementary_Figure_3.csv")
```
...
bind_rows(list(
  ...
  write_csv("results/source_data/Supplementary_Figure_2b.csv")

cohort_cor_boxplot <- bind_rows(list(
  `inter-cohort` = inter_cohort_qc_cor %>% select(sample1, sample2, r),
  `intra-cohort` = intra_cohort_qc_cor %>% select(sample1, sample2, r)
), .id = "type") %>%
  write_csv("results/source_data/Supplementary_Figure_2c.csv")
```
